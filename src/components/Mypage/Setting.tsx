    ...
    return (
        <div>
            <div className='setting'>
                <svg onClick={handleEditClick} viewBox="0 0 120 120" fill='#4A9999' width="25" height="25">
                ...
                {isSetting &&
                    <div className='setting_popup'>
                        <div onClick={handlePopUpClick}>닉네임 변경</div>
                        <div onClick={handlePopUpClick}>소개 변경</div>
                        <div onClick={handlePopUpClick}>로그아웃</div>
                    </div>}
            </div>
            { popUp &&
                <div>
                    <div onClick={handleEditCancel} className='setting_popup_bg'></div>
                    <div className='setting_popup_nickname'>
                        <div className='nick_textarea'>
                            <div className='nick'>변경할 닉네임을 입력해주세요</div>
                            <textarea
                        ...
                        <div className='popup_btn'>
                            <div className='popup_btn_yes'>확인</div>
